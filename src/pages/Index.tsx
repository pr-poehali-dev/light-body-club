        ...
        <div className="container relative grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mb-8 leading-relaxed">
              Пространство для женщин, где забота о теле становится естественной
              частью жизни, а лёгкость, энергия и свобода движений — вашим новым
              состоянием. Мягкие практики, живые занятия и готовые комплексы даже
              для плотного графика.
            </p>
